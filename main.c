...
enum{telaInicial, telaJogo, telaCred};
//enums para cada tela de jogo que ser� controlado pelo INT statusTela que ser� iniciado com telaInicial
int statusTela;
int main() {
	init();
    while (!exit_program) {//enquanto a vari�vel exit_program�vel for n�o falso, executa os comandos
...
void drawTelaJogo(){
     ...
     while(!exit_program && !exit_screen){
          ...
          if(pontV == 1200){//se a variavel pontV acumular mais 3600 pontos, ir� adicionar uma vida e ir� zerar pontV
               addLife();
               pontV = 0;
          }
          p1.x = MAX_X/2-240;
        ...
        if(colli(x,y, bola->w,bola->h,x2,y2,prato->w,prato->h)==TRUE){
                     ...
                     if(topo==0){topo=1;}if(topo==1){topo=0;}
        }
        ...
        if(y <= 233 && x >=160 && x<= 630 && y >=30 ){
             if(y <=233 && y >=30 && x >=572 && x<= 642){
                  if(y <=240  && y >=210){
                        if(ametista[5] !=t){
                                       ...
                                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ametista[5]=t;}
                  if(y <=210  && y >=180){
                       if(ouro[5] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                       
                  }ouro[5]=t;}
                  if(y <=180  && y >=150){
                       if(citrino[5] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }citrino[5]=t;}
                  if(y <=150  && y >=120){
                        
                       if(rubi[5] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }rubi[5]=t;}
                  if(y <=120  && y >=90){
                        
                       if(esmeralda[5] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  ...
                  if(y <=90  && y >=30){
                       ...
                       if(lapislazuli[5] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }lapislazuli[5]=t;}
             }
             ...
             if(y <=240  && y >=210){
                       ...
                       if(ametista[4] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ametista[4]=t;}
                  if(y <=210  && y >=180){
                        
                       if(ouro[4] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ouro[4]=t;}
                  if(y <=180  && y >=150){
                        
                       if(citrino[4] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }citrino[4]=t;}
                  if(y <=150  && y >=120){
                        
                       if(rubi[4] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }rubi[4]=t;}
                  if(y <=120  && y >=90){
                        
                       if(esmeralda[4] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }esmeralda[4]=t;}
                  if(y <=90  && y >=30){
                        
                       if(lapislazuli[4] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }lapislazuli[4]=t;}
             }
             ...
             if(y <=240  && y >=210){
                       ...
                       if(ametista[3] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ametista[3]=t;}
                  if(y <=210  && y >=180){
                        
                       if(ouro[3] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ouro[3]=t;}
                  if(y <=180  && y >=150){
                        
                       if(citrino[3] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }citrino[3]=t;}
                  if(y <=150  && y >=120){
                       ...
                       if(rubi[3] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }rubi[3]=t;}
                  if(y <=120  && y >=90){
                       ...
                       if(esmeralda[3] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }esmeralda[3]=t;}
                  if(y <=90  && y >=30){
                        
                       if(lapislazuli[3] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }lapislazuli[3]=t;}
             }
             ...
             if(y <=240  && y >=210){
                       ...
                       if(ametista[2] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ametista[2]=t;}
                  if(y <=210  && y >=180){
                        
                       if(ouro[2] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ouro[2]=t;}
                  if(y <=180  && y >=150){
                        
                       if(citrino[2] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }citrino[2]=t;}
                  if(y <=150  && y >=120){
                        
                       if(rubi[2] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }rubi[2]=t;}
                  if(y <=120  && y >=90){
                        
                       if(esmeralda[2] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }esmeralda[2]=t;}
                  if(y <=90  && y >=30){
                        
                       if(lapislazuli[2] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }lapislazuli[2]=t;}
             }
             ...
             if(y <=240  && y >=210){
                       ...
                       if(ametista[1] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ametista[1]=t;}
                  if(y <=210  && y >=180){
                        
                       if(ouro[1] !=t){ pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }ouro[1]=t;}
                  if(y <=180  && y >=150){
                        
                       if(citrino[1] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }citrino[1]=t;}
                  if(y <=150  && y >=120){
                        
                       if(rubi[1] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }rubi[1]=t;}
                  if(y <=120  && y >=90){
                        
                       if(esmeralda[1] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  }esmeralda[1]=t;}
                  if(y <=90  && y >=30){
                        
                       if(lapislazuli[1] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                       pont+=100;
                  }lapislazuli[1]=t;}
            ...
            if(y <=231  && y >=37 && x >=137 && x<= 217){
             ...
             if(y <=240  && y >=210){
                       ...
                       if(ametista[0] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}
                  pont+=100;}ametista[0]=t;}
                  if(y <=210  && y >=180){
                        
                       if(ouro[0] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}pont+=100;}ouro[0]=t;}
                  if(y <=180  && y >=150){
                        
                       if(citrino[0] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  pont+=100;}citrino[0]=t;}
                  if(y <=150  && y >=120){
                        
                       if(rubi[0] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                  pont+=100;}rubi[0]=t;}
                  if(y <=120  && y >=90){
                       if(esmeralda[0] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                       pont+=100;
                  }esmeralda[0]=t;}
                  if(y <=90  && y >=30){
                       if(lapislazuli[0] !=t){pont+=100;pontV+=100;
                       play_sample(breakBlockGlass, 255, 128, 1000, 0);
                       if(esq==1){esq=0;}if(esq==1){esq=0;}if(esq==0){esq=1;}if(topo==1){topo=0;}if(topo==0){topo=1;}
                       pont+=100;
...
void drawTelaInicial(){
     ...
     int sJogo = FALSE, exit_screen = FALSE;
     while(!exit_program && !exit_screen){
          if(key[KEY_ESC]){//se a tecla esc for precionada, a vari�vel exit_program recebe TRUE, com isso, o looping principal � interrompido
               exit_program = TRUE;
          }
...
void addPont(int p){//dependendo da cordenada(o valor de y), p ter� um valor que ser� adicionado a pont e pontV
     pont += p;
     pontV += p;
}
